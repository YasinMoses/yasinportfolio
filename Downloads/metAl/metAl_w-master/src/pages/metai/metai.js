...
import MetAITable from '../../components/metaiTable'
...
class MetAITableData extends Component {
  constructor(props) {
    super(props);
    this.state = {
      users: [],
    ...
    return (
      <div>
        <ol className="breadcrumb float-xl-right">
          ...
          <li className="breadcrumb-item active">MetAIs Table</li>
        </ol>
        <h1 className="page-header">MetAIs </h1>
        <Panel>
          <PanelHeader>MetAIs Management</PanelHeader>
