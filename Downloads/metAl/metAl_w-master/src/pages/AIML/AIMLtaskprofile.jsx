...
import BasicInfo from "./AIMLtask/BasicInfoFields/BasicInfo.jsx";
import {
  Panel,
  PanelHeader,
  PanelBody,
...
import Spreadsheet from "../../components/Spreadsheet/SpreadSheet.jsx";  // Add correct path
// import Fishbone from "../../components/fishbone/Fishbone";  // Add correct path
...
class AIMLTaskprofile extends React.Component {
  ...
  mapToViewModel(AIMLtask, sharedusers) {
    return {
      _id: AIMLtask._id,
      username: AIMLtask?.userID?.username,
      name: AIMLtask?.name,
      description: AIMLtask?.description,	  
  ...
  actions = [
    ...
    { label: "Save as XLS", icon: "fas-fa-file-excel",trigger: () => {}, },
    { label: "Save as CSV", icon: "fa-csv",trigger: () => {},  },
  ];
      ...
      <div>
        ...
        <div className="row">
          <div className="col-12">
            <Panel>
              <PanelHeader noButton>AIMLtask</PanelHeader>
              <PanelBody>
                <ReusableTabNavs
                  ...
                  navprops={[
                    { label: "Basic information", background: "#e81416" },
                    { label: "Model", background: "#ffa500" },					
                    { label: "Py Command", background: "#faeb36" },
                    { label: "Jupyter Notebook", background: "#79c314" },
                    { label: "Sharing", background: "#4b369d" },
                    { label: "Notes", background: "#70369d" },
                  ]}
                />
                <TabContent activeTab={this.state.activeTab}>
                  ...
                  <ReusableTab id={6}>
                    <>
                      <h4>Notes</h4>
                      <p>
                        AIMLtask nr 10 making use of file email/inbox to for
