...
class RefereesTable extends Component {
  ...
  columns = [
    ...
    { label: "ID-Paper Valid Till", path: "Referees.identification.idPaperValidTill"},
    ...
    { label: "Status", path: "Referees.status" },
  ];

  render() {
    const { referees: Referees, onSort, sortColumn } = this.props;
