...
class ExaminatorsTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      values: [],
  ...
  columns = [
    ...
    { label: "ID-Paper Valid Till", path: "Examinators.identification.idPaperValidTill"},
    { label: "Grades", path: "professionalInfo.grades" },
    ...
    { label: "Status", path: "Examinators.status" },
  ];

  render() {
    const { examinators: Examinators, onSort, sortColumn } = this.props;
...
export default ExaminatorsTable;
