...
class paramedicsTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      values: [],
  ...
  columns = [
    ...
    // { label: "ID-Paper Valid Till", path: "user.identification.idPaperValidTill"},
  ...
  render() {
    const { paramedics, onSort, sortColumn } = this.props;
...
export default paramedicsTable;
