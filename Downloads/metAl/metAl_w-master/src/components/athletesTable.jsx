...
class AthletesTable extends Component {
  ...
  columns = [
    ...
    { label: "ID-Paper Valid Till", path: "Athletes.identification.idPaperValidTill"},
    ...
    { label: "Status", path: "Athletes.status" },
  ];

  render() {
    const { athletes: Athletes, onSort, sortColumn } = this.props;
