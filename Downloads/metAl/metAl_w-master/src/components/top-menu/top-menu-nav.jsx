...
class TopMenuNav extends React.Component {
  ...
  controlRight(e) {
    ...
    var widthLeft =
      this.state.navWidth + -this.state.marginLeft - containerWidth;
      ...
      >
        ...
        <li
          className={
            ...
            (this.state.controlLeft ? "show" : "")
          }
        >
          <Link to="/" onClick={this.controlLeft}>
        ...
        <li
          className={
            ...
            (this.state.controlRight ? "show" : "")
          }
        >
          <Link to="/" onClick={this.controlRight}>
