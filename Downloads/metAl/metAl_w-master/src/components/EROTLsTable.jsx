...
class EROTLTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      values: [],
  ...
  columns = [
    ...
    { label: "ID-Paper", path: "user.identification.idPaper" },
    {
      ...
      path: "EROTLs.identification.idPaperValidTill",
    },
    ...
    { label: "Status", path: "EROTLs.status" },
  ];

  render() {
    const { eros: EROTLs, onSort, sortColumn } = this.props;
