...
class TeachersTable extends Component {
  ...
  columns = [
    ...
    { label: "ID-Paper Valid Till", path: "Teachers.identification.idPaperValidTill"},
    ...
    { label: "Status", path: "Teachers.status" },
  ];

  render() {
    const { teachers: Teachers, onSort, sortColumn } = this.props;
